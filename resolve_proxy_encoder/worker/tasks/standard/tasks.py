...
@app.task()
def check_worker_version():
    """Check worker's locally installed version of RPE.

    Wraps 'get_package_current_commit' from helper functions"""
    return helpers.get_package_current_commit
