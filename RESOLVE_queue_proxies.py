...
from handlers import proxy_handlers
...
sm = SettingsManager(constants.USER_PREFS_PATH)
sm.ingest(app_settings.defaults)
app_prefs = sm.get()

debug = app_prefs['app']['debug']
...
if __name__ == "__main__":
    ...
    try:       
        ...
        clips = proxy_handlers.handle_already_linked(clips)
        clips = proxy_handlers.handle_offline_proxies(clips)
        clips = proxy_handlers.handle_existing_unlinked(clips)
